        ...
        <div>
            ...
            <div className="card divsb" id="scrollspyHeading1">
                <div className="row g-0 ">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton1  titulo2 ">
            ...
            <div className="card divsb" id="scrollspyHeading2">
                <div className="row g-0">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton2  titulo2">
                          <div className="card-body ">
            ...
            <div className="card divsb" id="scrollspyHeading3">
                <div className="row g-0">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton4  titulo2">
                          <div className="card-body ">
            ...
            <div className="card divsb" id="scrollspyHeading4">
                <div className="row g-0">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton6  titulo2">
                          <div className="card-body ">
            ...
            <div className="card divsb" id="scrollspyHeading5">
                <div className="row g-0">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton7  titulo2">
                          <div className="card-body ">
            ...
            <div className="card divsb" id="scrollspyHeading6">
                <div className="row g-0">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton3  titulo2">
                          <div className="card-body ">
            ...
            <div className="card divsb" id="scrollspyHeading7">
                <div className="row g-0">
                       <div className="col-md-6 d-flex justify-content-center align-items-center colorbutton5  titulo2">
                          <div className="card-body ">
